...
const (
	...
	MaxSitemapFilesize = 8457280 // bytes
)
...
const (
	...
	//baidu
	Baidu_SchemaMobile = "http://www.baidu.com/schemas/sitemap-mobile/1/"
...
var (
	...
	Baidu_XMLHeader = []byte(`<?xml version="1.0" encoding="UTF-8" ?> 
